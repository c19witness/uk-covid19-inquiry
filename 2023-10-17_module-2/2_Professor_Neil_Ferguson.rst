...
**Professor Neil Ferguson**: Yes. So the issue is about what proportion of time -- maybe I'll start again. So mass gatherings I think intuitively sound like risky things, because you might have 10,000 people together, but for a virus which transmits through :outline:`close contact`, in fact if you have only one infected person they're no more likely to generate large numbers of infections than they would be, for instance -- in a pub, for instance, or a theatre.
