...
**Lead Inquiry**: The next broad area is that of environmental controls, on page 39. In the general scheme of things, if the rubric or the aim is to control the spread of a virus, how important are environmental measures such :outline:`as air cleaning` devices, :outline:`ventilation`, :outline:`surface disinfection`, screens and so on?

**Sir Mark Walport**: I'd say that, disappointingly, this was the area where there is the weakest experimental evidence, and there are a small number of observational studies that show -- appear to show the effectiveness of environmental measures, and that's everything from reducing the number of people in an environment to :outline:`increasing ventilation`.

Again, everything that is known about the transmission of infection says that one way of reducing the exposure to exhaled virus is to :outline:`increase the ventilation`, so having :outline:`open windows`, :outline:`increasing air flow`, but there is remarkably little rigorous evidence that could be adduced, and I think it's one of those cases where absence of evidence should not be taken to be evidence of absence. In other words, because we can't demonstrate it doesn't mean that there wasn't an effect.
